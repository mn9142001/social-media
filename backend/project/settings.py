...
SIMPLE_JWT = {
    ...
    "TOKEN_USER_CLASS": "user.models.token_user",
}
...
SECRET_KEY = 'django-insecure-7qv%u88qfm!c*_zx07qgn04ih*(%+ym+ks52bcvo(*!zm1*2uf'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES' : ('user.auth.TenantStatelessAuthentication',),
